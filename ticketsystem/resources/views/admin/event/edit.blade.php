        ...
        <div class="bg-white p-8 rounded shadow-lg w-1/3 max-h-schreen">
            ...
            <form action="{{ route('admin.update', $event) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input id="description" type="hidden" name="description" value="{{ $event->description }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="date" name="date" class="form-input rounded-md w-full" value="{{ old('date', date('Y-m-d', strtotime($event->date))) }}">
                    @error('date')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
